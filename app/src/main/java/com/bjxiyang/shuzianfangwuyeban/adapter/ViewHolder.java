...
//                (ImageView) getView(viewId));
        ImageLoaderManager.getInstance(getView(viewId).getContext())
                .displayImage((ImageView) getView(viewId),url);
        return this;
    }
    ...
    public ViewHolder setListView(int viewId, List<String> mList)
    {
